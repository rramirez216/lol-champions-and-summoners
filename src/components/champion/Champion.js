      ...
      {isLoading ? (
        ...
        <div className='champion-card'>
          <div className='champion-image-wrapper'>
            <img
              src={`https://ddragon.leagueoflegends.com/cdn/img/champion/splash/${champInfo.id}_0.jpg`}
              alt={`${champInfo.name} ${champInfo.title}`}
            />
          </div>
          ...
          <div className='spells-list-wrapper'>
            <div className='spell flex-column'>
              ...
              <div className='spell-image-wrapper'>
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/11.24.1/img/passive/${champInfo.passive.image.full}`}
                  alt='passive ability description'
                />
              </div>
              <p>Passive</p>
            </div>
            <div className='spell flex-column'>
              ...
              <div className='spell-image-wrapper'>
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/11.24.1/img/spell/${champInfo.spells[0].image.full}`}
                  alt='Q spell description'
                />
              </div>
              <p>Q</p>
            </div>
            <div className='spell flex-column'>
              ...
              <div className='spell-image-wrapper'>
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/11.24.1/img/spell/${champInfo.spells[1].image.full}`}
                  alt='W spell description'
                />
              </div>
              <p>W</p>
            </div>
            <div className='spell flex-column'>
              ...
              <div className='spell-image-wrapper'>
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/11.24.1/img/spell/${champInfo.spells[2].image.full}`}
                  alt='E spell description'
                />
              </div>
              <p>E</p>
            </div>
            <div className='spell flex-column'>
              ...
              <div className='spell-image-wrapper'>
                <img
                  src={`https://ddragon.leagueoflegends.com/cdn/11.24.1/img/spell/${champInfo.spells[3].image.full}`}
                  alt='R spell description'
                />
              </div>
              <p>R</p>
            </div>
